...
集中管理智能体，查看启用与发布状态，快速进入对话、配置和发布管理。

![智能体工作台：智能体卡片、启用状态与发布管理入口](picture/agents.png)

### 记忆管理

查看记忆分类与作用范围，确认、编辑或停用记忆，并分析重复与冲突。

![记忆管理：记忆条目、分类、确认状态与治理操作](picture/remember.png)

### 独立 Web 应用

将智能体发布为独立聊天页面，支持历史会话与交互卡片展示。下图为 Show Map 地图工具的使用示例。

![发布后的 Web 应用：独立会话侧栏与 Show Map 地图交互卡片](picture/web.png)
